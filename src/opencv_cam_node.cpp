...
namespace opencv_cam {
    ...
    OpencvCamNode::OpencvCamNode(const rclcpp::NodeOptions &options, const std::string cam_name,
            ...
            Node("opencv_cam" + cam_name, options),
            canceled_(false) {
...
#define CXT_MACRO_MEMBER(n, t, d) CXT_MACRO_CHECK_CMDLINE_PARAMETER(n, t, d)
        ...
        cxt_.camera_info_path_ = camera_info_path;
        cxt_.camera_frame_id_ = camera_frame_id;
